...
//Class 
//var Trees; 
//We want to create a specific variable for the object
//var myTrees; - 4/18/21 when I create the var the screen goes white
...
function setup()
{
    ...
    //Create an object of the class Trees ( should be new Trees instead of ellipse)
    myTrees = new Trees(300, 430, 10, 50, 144, 238, 144);
    myTrees2 = new Trees(500, 420, 10, 70, 144, 238, 144);
    Trees = new Trees(400, 420, 10, 70, 144, 238, 144);
...
function draw()
{
    ...
    Arrays();
   // use the variable that was created above. We don't want to call the class directly
    //Trees.display();
    myTrees.display();
    myTrees2.display();
    Trees.display();
